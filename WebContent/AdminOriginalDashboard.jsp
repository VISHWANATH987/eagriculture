...
<body>
	...
	<header id="site-header" class="fixed-top">
		<div class="container-fluid">
			<jsp:include page="AdminSideHeaderOriginal.jsp"></jsp:include>
		</div>
	</header>
	<!-- //header -->
	<!-- about breadcrumb -->
		...
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="AdminManageCropsOriginal.jsp" class="text-dark">Total Crops</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="AdminManagePesticidesOriginal.jsp" class="text-dark">Total Pestisides</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="AdminManageInsecticidesOriginal.jsp" class="text-dark">Total Insectisides</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="AdminManageEquipmentsOriginal.jsp" class="text-dark">Total Equipments</a></strong>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="AdminViewCustomersOriginal.jsp" class="text-dark">Total Sellers</a></strong>
				</div>
			</div>
	<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="AdminViewContactsOriginal.jsp" class="text-dark">Total Contacts</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a
						href="AdminViewAllAdminOriginal.jsp" class="text-dark">Total Buyers</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					%>
					<h3>
						<font color="#FF9933"><span class="counter">4</span></font>
					</h3>
					<strong style="font-size: 22px;"><a href="AdminViewReportOriginal.jsp" class="text-dark">View Reports</a></strong>
				</div>
			</div>
		</div>
	</div>
