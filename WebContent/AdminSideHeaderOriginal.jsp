	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		<ul class="navbar-nav ml-auto">
			<li class="nav-item active"><a class="nav-link"
				href="AdminOriginalDashboard.jsp">Dashboard <span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item"><a class="nav-link" href="AdminManageCropsOriginal.jsp">Manage
					Crops</a></li>
			<li class="nav-item"><a class="nav-link" href="AdminManageInsecticidesOriginal.jsp">Manage
					Insecticides</a></li>
			<li class="nav-item"><a class="nav-link" href="AdminManageEquipmentsOriginal.jsp">Manage
					Equipments</a></li>
			<li class="nav-item"><a class="nav-link" href="AdminManagePesticidesOriginal.jsp">Manage
					Pesticides</a></li>
			
			<li class="nav-item"><a class="nav-link" href="AdminViewReportOriginal.jsp">View
					Reports</a></li>
			...
			<li id="menu-item-26"
				...
				<div class="sub-menu dropdown-menu"
					...
					<a href="AdminViewProfileOriginal.jsp" class="dropdown-item active" id="menu-item-27">View
						Profile</a> <a href="AdminChangePasswordOriginal.jsp" class="dropdown-item active" id="menu-item-27">Settings</a>
