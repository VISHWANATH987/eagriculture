		...
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="customer-view-crops.jsp" class="text-dark">Total Crops</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="customer-view-pesticides.jsp" class="text-dark">Total Pestisides</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="customer-view-insecticide.jsp" class="text-dark">Total Insectisides</a></strong>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="customer-view-equipments.jsp" class="text-dark">Total Equipments</a></strong>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="admin-view-customers.jsp" class="text-dark">Total Sellers</a></strong>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="admin-view-customer-crops-selling-details.jsp" class="text-dark">View Farmers Selling Products</a></strong>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<strong style="font-size: 22px;"><a href="ViewStatus.jsp" class="text-dark">View Products Status</a></strong>
				</div>
			</div>
