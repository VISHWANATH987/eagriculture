		...
		<div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
			<div class="container">
				...
				<ul class="breadcrumbs-custom-path mt-2">
					<li><a href="#url">Seller</a></li>
					<li class="active"><span class="fa fa-arrow-right mx-2"
						aria-hidden="true"></span>Seller Login</li>
				</ul>
			</div>
		</div>
	</section>
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-info shadow p-3 mb-5">
					<div class="panel-heading">Seller Account</div>
					<div class="panel-body">
						...
						<form action="CustomerLogin" method="post">
							...
							%>
							<div class="form-group">
								<label for="vercode">Captcha Code:</label> <input
							...
							<a href="customer-account.jsp">Click here to new seller account.</a>
						</form>
					</div>
				</div>
			</div>
