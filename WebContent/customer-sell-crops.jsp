...
<body>
	...
	<div class="container-fluid">
		...
		<div class="panel panel-info shadow p-3 mb-5">
			<div class="panel-heading">Sell products</div>
			<div class="panel-body">
				...
				%>
				<div class="alert alert-success" id="success">Product sell
					successfully.</div>
				<%
					}
				%>
				...
				<form action="CustomerSellCrops" method="post">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="cropName">Product Name:</label> <input type="text"
								class="form-control" id="cropName" placeholder="Product Name"
								name="cropName" value="" required>
						</div>
						<div class="form-group col-md-6">
							<label for="quantity">Quantity:</label> <input type="text"
								class="form-control" id="quantity"
								placeholder="Enter product Quantity" name="quantity" value=""
								required>
						</div>
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="cropDescription">Product Description:</label>
							<textarea class="form-control" id="cropDescription"
								placeholder="Product Description" name="cropDescription"></textarea>
						</div>
					</div>
					
					<input type="submit" value="Sell Product" class="btn btn-primary">
