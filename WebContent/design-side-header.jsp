			...
			<li id="menu-item-26"
				...
				<div class="sub-menu dropdown-menu"
					...
					<a href="customer-login.jsp" class="dropdown-item "
						id="menu-item-27">Seller Login</a> <a
						href="customer-account.jsp" class="dropdown-item"
						id="menu-item-28">Seller Account</a>
				</div></li>
			<li id="menu-item-26"
				class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-26 nav-item active dropdown"><a
				href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
				...
				<div class="sub-menu dropdown-menu"
					...
					<a href="admin-login.jsp" class="dropdown-item "
						id="menu-item-27">Buyer Login</a> <a href="admin-account.jsp"
						class="dropdown-item " id="menu-item-27">Buyer Account</a>
				</div></li>
				...
				<div class="sub-menu dropdown-menu"
					aria-labelledby="navbar-dropdown-menu-link-26">
					<a href="OriginalAdminLogin.jsp" class="dropdown-item "
						id="menu-item-27">Admin Login</a> <a href="OriginalAdminLogin.jsp"></a>
				</div></li>
